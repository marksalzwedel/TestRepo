...
"(Generated by ChatGPT; may contain occasional errors. For confirmation or pastoral care, please contact Christ Lutheran Church via christlutheran.com, or click on the "Talk to a Person" button.)"
`.trim();
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const reply =
      ...
      'I’m not certain. Would you like to chat with a person?';
